...
| Validation regressions | `/workflow:validate {FEATURE_NAME}` | Score remains at least 90 | {GATE_OWNER} |
...
| Quality gate | `/workflow:validate {FEATURE_NAME}` | Score remains at least 90 and critical issues remain zero |
