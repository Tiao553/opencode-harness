...
| **KB Domains** | {List domains from ~/.config/opencode/kb/ relevant to this feature} | {Which patterns to consult} |
...
**Ready for:** `/workflow:design ~/.config/opencode/sdd/features/{feature-name}/DEFINE_{FEATURE_NAME}.md`
