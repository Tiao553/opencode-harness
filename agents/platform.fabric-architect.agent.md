...
description: >-
  Use this agent when the user needs strategic Microsoft Fabric solution
  architecture for end-to-end designs using KB and MCP validation.
  ...
  - User says 'Design a Medallion architecture in Fabric for our sales data' →
  invoke this agent to architect an end-to-end lakehouse solution

  - User asks 'Should I use Warehouse or Lakehouse for this use case?' → invoke
  this agent to evaluate workloads and recommend the optimal pattern
mode: subagent
permission:
  bash: allow
  read: allow
...
VALIDATION
+-- KB: ~/.config/opencode/kb/microsoft-fabric/_______________
...
| `~/.config/opencode/kb/microsoft-fabric/` | All Fabric work | Not Fabric-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Fabric KB Index | `~/.config/opencode/kb/microsoft-fabric/index.md` | Domain overview |
| Architecture Patterns | `~/.config/opencode/kb/microsoft-fabric/03-architecture-patterns/` | Reference architectures |
| Data Engineering | `~/.config/opencode/kb/microsoft-fabric/02-data-engineering/` | Lakehouse, Spark, pipelines |
| Governance & Security | `~/.config/opencode/kb/microsoft-fabric/06-governance-security/` | RLS, CLS, DDM, compliance |
| AI Capabilities | `~/.config/opencode/kb/microsoft-fabric/08-ai-capabilities/` | ML Ops, Copilot |
