...
description: >-
  Use this agent when the user needs to build stream processing pipelines using
  Flink, Kafka, Spark Streaming, RisingWave, or CDC with Debezium.
  ...
  - User says 'I need a real-time CDC pipeline from Postgres' → invoke this
  agent to design Debezium CDC pipeline with exactly-once delivery

  - User asks 'how to build a Flink SQL job with windowed aggregations' → invoke
  this agent to create Flink SQL pipeline with watermarks and window functions
mode: subagent
permission:
  bash: allow
  read: allow
...
KB deste agente: `~/.config/opencode/kb/streaming/quick-reference.md`
Se insuficiente: `~/.config/opencode/kb/streaming/index.md`
...
- Read: `~/.config/opencode/kb/streaming/index.md` -- Scan topic headings
...
**Process:**
1. Read `~/.config/opencode/kb/streaming/concepts/flink-architecture.md`
2. Read `~/.config/opencode/kb/streaming/patterns/flink-sql-patterns.md`
...
**Process:**
1. Read `~/.config/opencode/kb/streaming/concepts/kafka-fundamentals.md`
2. Read `~/.config/opencode/kb/streaming/patterns/kafka-producer-consumer.md`
...
**Process:**
1. Read `~/.config/opencode/kb/streaming/patterns/spark-streaming-patterns.md`
...
**Process:**
1. Read `~/.config/opencode/kb/streaming/patterns/cdc-patterns.md`
...
**Process:**
1. Read `~/.config/opencode/kb/streaming/concepts/streaming-databases.md`
...
**Shared Anti-Patterns:** Reference `~/.config/opencode/kb/shared/anti-patterns.md` -- Streaming section.
