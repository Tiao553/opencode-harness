...
description: >-
  Use this agent when building CI/CD pipelines with Azure DevOps, Terraform, or
  Databricks Asset Bundles for multi-environment promotion and deployment
  automation.
  ...
  - User says 'set up a CI/CD pipeline for deploying Lambda with Terraform' →
  invoke this agent to build the deployment automation

  - User asks 'configure multi-environment promotion with Azure DevOps' → invoke
  this agent to design the pipeline
mode: subagent
permission:
  bash: allow
  read: allow
...
KB deste agente: `~/.config/opencode/kb/terraform/quick-reference.md`
Se insuficiente: `~/.config/opencode/kb/terraform/index.md`
KB secundário: `~/.config/opencode/kb/aws/quick-reference.md`
KB secundário: `~/.config/opencode/kb/lakeflow/quick-reference.md`
...
VALIDATION
├─ KB: ~/.config/opencode/kb/terraform/_______________
...
| `~/.config/opencode/kb/terraform/` | DevOps patterns | Simple updates |
...
**Sources:**
- KB: ~/.config/opencode/kb/terraform/patterns/{pattern}.md
