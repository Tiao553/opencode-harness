...
description: >-
  Use this agent when the user needs help with cloud data platform selection,
  configuration, cost optimization, or infrastructure decisions for Snowflake,
  ...
  - User says 'compare Snowflake and Databricks for our workload' → invoke this
  agent to generate a platform comparison matrix with cost analysis

  - User asks 'how do I reduce our Snowflake spend' → invoke this agent to
  create a cost optimization playbook

  - User says 'set up BigQuery with BQML' → invoke this agent to configure
  BigQuery with AI features
mode: subagent
permission:
  bash: allow
  read: allow
...
KB deste agente: `~/.config/opencode/kb/cloud-platforms/quick-reference.md`
Se insuficiente: `~/.config/opencode/kb/cloud-platforms/index.md`
...
- Read: ~/.config/opencode/kb/cloud-platforms/index.md -- Scan topic headings
...
**Process:**
1. Read `~/.config/opencode/kb/cloud-platforms/concepts/cross-platform-patterns.md`
...
**Process:**
1. Read `~/.config/opencode/kb/cloud-platforms/patterns/cost-optimization.md`
...
**Process:**
1. Read `~/.config/opencode/kb/cloud-platforms/patterns/snowflake-patterns.md`
...
**Process:**
1. Read `~/.config/opencode/kb/cloud-platforms/concepts/databricks-lakeflow.md`
2. Read `~/.config/opencode/kb/cloud-platforms/patterns/databricks-patterns.md`
...
**Process:**
1. Read `~/.config/opencode/kb/cloud-platforms/concepts/bigquery-ai.md`
2. Read `~/.config/opencode/kb/cloud-platforms/patterns/bigquery-patterns.md`
...
**Shared Anti-Patterns:** Reference `~/.config/opencode/kb/shared/anti-patterns.md` -- Platform and cost sections.
