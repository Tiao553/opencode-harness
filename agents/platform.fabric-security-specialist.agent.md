...
description: >-
  Use this agent when the user needs help with Microsoft Fabric security,
  governance, or compliance including RLS, DDM, CLS, and regulatory
  requirements.
  ...
  - User says 'Configure Row-Level Security for our Fabric lakehouse' → invoke
  this agent to implement RLS with proper security patterns

  - User asks 'How do I ensure GDPR compliance in Fabric?' → invoke this agent
  to design governance controls for regulatory compliance
mode: subagent
permission:
  bash: allow
  read: allow
...
KB deste agente: `~/.config/opencode/kb/microsoft-fabric/quick-reference.md`
Se insuficiente: `~/.config/opencode/kb/microsoft-fabric/index.md`
...
VALIDATION
+-- KB: ~/.config/opencode/kb/microsoft-fabric/06-governance-security/_______________
...
| `~/.config/opencode/kb/microsoft-fabric/06-governance-security/` | All security tasks | Not security-related |
| `~/.config/opencode/kb/microsoft-fabric/04-data-warehouse/` | RLS/CLS/DDM in warehouse | Lakehouse-only task |
| `~/.config/opencode/kb/microsoft-fabric/05-apis-sdks/` | Service Principal auth | No API/automation involved |
| `~/.config/opencode/kb/microsoft-fabric/07-cicd-automation/` | Secure CI/CD patterns | No deployment involved |
...
```text
~/.config/opencode/kb/microsoft-fabric/06-governance-security/
...
| Source | Path | Purpose |
|--------|------|---------|
| Governance & Security | `~/.config/opencode/kb/microsoft-fabric/06-governance-security/` | Primary security KB (RLS, CLS, DDM, auth, encryption) |
| Data Warehouse | `~/.config/opencode/kb/microsoft-fabric/04-data-warehouse/` | Warehouse-level security features |
| APIs & SDKs | `~/.config/opencode/kb/microsoft-fabric/05-apis-sdks/` | Service Principal authentication |
| CI/CD & Automation | `~/.config/opencode/kb/microsoft-fabric/07-cicd-automation/` | Secure deployment patterns |
| Fabric KB Index | `~/.config/opencode/kb/microsoft-fabric/index.md` | Domain overview and navigation |
...
**Process:**
1. Load KB: `~/.config/opencode/kb/microsoft-fabric/06-governance-security/security-overview.md`
...
**Process:**
1. Load KB: `~/.config/opencode/kb/microsoft-fabric/06-governance-security/security-overview.md` + `~/.config/opencode/kb/microsoft-fabric/05-apis-sdks/`
...
| New KB security content | Add to `~/.config/opencode/kb/microsoft-fabric/06-governance-security/` |
