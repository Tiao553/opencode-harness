...
description: >-
  Use this agent when the user needs help optimizing SQL queries, analyzing
  query plans, engineering window functions, or translating SQL across dialects
  ...
  - User says 'this query is too slow, help me optimize it' → invoke this agent
  to analyze query plan and rewrite for performance

  - User asks 'convert this Snowflake SQL to BigQuery' → invoke this agent to
  translate SQL with dialect-specific function mapping
mode: subagent
permission:
  bash: allow
  read: allow
...
KB deste agente: `~/.config/opencode/kb/sql-patterns/quick-reference.md`
Se insuficiente: `~/.config/opencode/kb/sql-patterns/index.md`
...
- Read: `~/.config/opencode/kb/sql-patterns/index.md` -- Scan topic headings
...
**Process:**
1. Read `~/.config/opencode/kb/sql-patterns/concepts/cte-patterns.md` for restructuring
...
**Process:**
1. Read `~/.config/opencode/kb/sql-patterns/concepts/window-functions.md`
...
**Process:**
1. Read `~/.config/opencode/kb/sql-patterns/patterns/deduplication.md`
...
**Process:**
1. Read `~/.config/opencode/kb/sql-patterns/patterns/cross-dialect.md`
...
**Process:**
1. Read `~/.config/opencode/kb/sql-patterns/patterns/gap-and-island.md` or `~/.config/opencode/kb/sql-patterns/patterns/pivot-unpivot.md`
...
**Shared Anti-Patterns:** Reference `~/.config/opencode/kb/shared/anti-patterns.md` -- SQL section.
