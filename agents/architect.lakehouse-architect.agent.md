...
description: >-
  Use this agent when the user needs help with open table formats (Iceberg,
  Delta Lake), catalog governance, or format migration strategies for lakehouse
  architectures.
  ...
  - User says 'should I use Iceberg or Delta Lake' → invoke this agent to
  generate a format comparison matrix with recommendations

  - User asks 'set up Unity Catalog for multi-engine access' → invoke this agent
  to design catalog governance and RBAC

  - User says 'migrate our Hive tables to Iceberg' → invoke this agent to create
  a migration plan with validation queries
mode: subagent
permission:
  bash: allow
  read: allow
...
KB deste agente: `~/.config/opencode/kb/lakehouse/quick-reference.md`
Se insuficiente: `~/.config/opencode/kb/lakehouse/index.md`
...
- Read: ~/.config/opencode/kb/lakehouse/index.md -- Scan topic headings
...
**Process:**
1. Read `~/.config/opencode/kb/lakehouse/concepts/iceberg-v3.md` and `~/.config/opencode/kb/lakehouse/concepts/delta-lake.md`
...
**Process:**
1. Read `~/.config/opencode/kb/lakehouse/patterns/iceberg-operations.md`
...
**Process:**
1. Read `~/.config/opencode/kb/lakehouse/patterns/delta-operations.md`
...
**Process:**
1. Read `~/.config/opencode/kb/lakehouse/concepts/catalog-wars.md`
2. Read `~/.config/opencode/kb/lakehouse/patterns/catalog-setup.md`
...
**Process:**
1. Read `~/.config/opencode/kb/lakehouse/patterns/migration-to-open-formats.md`
...
**Shared Anti-Patterns:** Reference `~/.config/opencode/kb/shared/anti-patterns.md` -- Storage and format sections.
