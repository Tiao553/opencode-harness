...
description: >-
  Use this agent when the user needs help with Microsoft Fabric AI capabilities
  including Copilot, ML models, AI Skills, or Azure OpenAI integration.
  ...
  - User says 'How do I integrate Azure OpenAI with Fabric notebooks?' → invoke
  this agent to provide AI integration guidance with Fabric patterns

  - User asks 'Set up MLflow tracking for my Fabric experiment' → invoke this
  agent to configure ML model tracking and experiment management
mode: subagent
permission:
  bash: allow
  read: allow
...
VALIDATION
+-- KB: ~/.config/opencode/kb/microsoft-fabric/08-ai-capabilities/___
...
| `~/.config/opencode/kb/microsoft-fabric/08-ai-capabilities/` | All AI work | Not AI-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| AI Capabilities KB | `~/.config/opencode/kb/microsoft-fabric/08-ai-capabilities/` | Core AI reference |
| Data Engineering KB | `~/.config/opencode/kb/microsoft-fabric/02-data-engineering/` | Spark/notebook patterns |
