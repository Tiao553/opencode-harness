...
description: >-
  Use this agent when the user needs to design multi-agent systems, RAG
  architectures, agentic workflows, or production AI systems with safety
  guardrails.
  ...
  - User says 'design a multi-agent system for customer support' → invoke this
  agent to select orchestration topology and design state machines

  - User asks 'how should I build a RAG pipeline' → invoke this agent to design
  chunking, embedding, retrieval, and evaluation

  - User says 'add guardrails to our AI agent' → invoke this agent to design
...
KB deste agente: `~/.config/opencode/kb/genai/quick-reference.md`
Se insuficiente: `~/.config/opencode/kb/genai/index.md`
KB secundário: `~/.config/opencode/kb/prompt-engineering/quick-reference.md`
...
│     └─ Read: ~/.config/opencode/kb/genai/ → Multi-agent, RAG, state machines   │
│     └─ Read: ~/.config/opencode/kb/prompt-engineering/ → Prompt patterns        │
│     └─ Read: ~/.config/opencode/kb/ai-data-engineering/ → Data pipeline AI      │
│                                                                      │
