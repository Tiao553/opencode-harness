...
```bash
/workflow:create-pr                           # Auto-detect changes and create PR
/workflow:create-pr "feat: add user auth"     # Create PR with custom title
/workflow:create-pr --draft                   # Create as draft PR
/workflow:create-pr --review                  # Run dual AI review before PR creation
/workflow:create-pr --review --draft          # Review + create as draft
```
...
```text
┌─────────────────────────────────────────────────────────────────┐
│                  /workflow:create-pr --review WORKFLOW                    │
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│   1. Analyze Changes                                             │
│          ↓                                                       │
...
| `*.md`, `docs/**` | `docs:` |
| `tests/**`, `*_test.py` | `test:` |
| `~/.config/opencode/**`, `Makefile`, `pyproject.toml` | `chore:` |
| `~/.config/opencode/agents/**` | `refactor(agents):` |
| `~/.config/opencode/kb/**` | `docs(kb):` |
| `~/.config/opencode/sdd/**` | `docs(sdd):` |
...
| `kb` | `~/.config/opencode/kb/**` |
| `sdd` | `~/.config/opencode/sdd/**` |
| `commands` | `~/.config/opencode/skills/workflow-commands/commands/**` |
...
```bash
/workflow:create-pr "refactor(agents): standardize agent definitions"
...
```bash
/workflow:create-pr --draft

# Detected: Changes in ~/.config/opencode/kb/
...
- Review Command: `~/.config/opencode/skills/review/commands/review.md`
- Code Reviewer Agent: `~/.config/opencode/agents/python.code-reviewer.agent.md`
- Workflow: `~/.config/opencode/sdd/_index.md`
- Agents: `~/.config/opencode/agents/workflow.*.agent.md`
