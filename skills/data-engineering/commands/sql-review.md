...
```bash
/data:sql-review <file-or-directory>
```

## Examples

```bash
/data:sql-review models/marts/mart_revenue.sql
/data:sql-review models/staging/
/data:sql-review "Review all SQL in this PR for Snowflake compatibility"
```
