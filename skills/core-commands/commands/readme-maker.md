...
```bash
/core:readme-maker                        # Full analysis → README.md
/core:readme-maker --output docs/         # Output to specific directory
/core:readme-maker --style minimal        # Minimal README (Quick Start focus)
/core:readme-maker --style comprehensive  # Full documentation (default)
/core:readme-maker --dry-run              # Preview without saving
```
...
Glob("**/workflow:build.gradle")      # Java/Gradle
...
/core:sync-context                    # Update ~/.config/opencode/AGENTS.md
/core:memory "Generated docs"         # Save what was done
```
