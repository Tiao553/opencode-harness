---
name: sync-context
description: Sync project context to ~/.config/opencode/AGENTS.md by analyzing codebase patterns and conventions
---

# Sync Context Command

Analyzes codebase and intelligently updates `~/.config/opencode/AGENTS.md` with current project context.

## Usage

```bash
/core:sync-context                    # Full analysis and update
/core:sync-context --section agents   # Update specific section
/core:sync-context --dry-run          # Preview changes without saving
```
...
3. **Merges** with existing ~/.config/opencode/AGENTS.md content
...
## ~/.config/opencode/AGENTS.md Template

Generated ~/.config/opencode/AGENTS.md follows this structure:
...
- **Agents**: Review ~/.config/opencode/agents/
...
```text
1. Read existing ~/.config/opencode/AGENTS.md
   │
   ▼
...
6. Validate (dry-run or save)
   │
   ▼
7. Write updated ~/.config/opencode/AGENTS.md
```
...
━━━━━━━━━━━━━━━━
~/.config/opencode/AGENTS.md updated successfully
```
...
| Output check | `~/.config/opencode/AGENTS.md` salvo com formatação Markdown válida | Reporte erro |
...
git commit -m "chore: update ~/.config/opencode/AGENTS.md with latest project structure"
```
